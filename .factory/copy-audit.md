...
| Copy | Words | Result |
|---|---:|---|
| A weekly billing attention queue | 5 | Pass |
...
| Bring the missed pieces of your paper trail into view. | 10 | Pass |
| Your local workspace | 3 | Pass |
| Start this week’s sweep | 4 | Pass |
...
| Keep the habit | 3 | Pass |
| Save repeat reviews for $19 once | 6 | Pass |
| Keep named weekly snapshots and compare past queue totals on this device. | 12 | Pass |
